...
urlpatterns = [
    ...
    path('productos/reconocer/quitar/', views.quitar_alias, name='quitar_alias'),
    ...
    path('productos/<int:producto_id>/variantes/', views.editar_atributos, name='editar_atributos'),
