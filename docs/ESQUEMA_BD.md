...
> Generado automáticamente por `python manage.py esquema_bd` el 2026-06-26 20:01. **No editar a mano** (se sobrescribe). Para análisis y mejoras ver `docs/ESQUEMA_NOTAS.md`.
